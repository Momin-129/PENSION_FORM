const Tehsil = {
  jammu: ["TSWO Akhnoor", "TSWO Bishnah", "TSWO Jammu", "TSWO R S Pura"],
  rajouri: ["TSWO Bhudhal", "TSWO Darhal", "TSWO Kalakote", "TSWO Rajouri"],
};
...
const PensionType = {
  ...
  "PHYSICALLY CHALLENGED PERSON": [
    ...
    {
      id: "kindOfDisability",
      "Kind of Disability": ["PERMANENT", "TEMPORARY"],
    },
    {
